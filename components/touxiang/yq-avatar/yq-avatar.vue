		...
		<view class="oper-wrapper" :style="{display: styleDisplay, height: tabStyleHeight}">
			<view class="oper">
				<view class="btn-wrapper">
					<view @click="fSelect"  hover-class="hover"><text>{{$t('touxiang.cx')}}</text></view>
					<view @click="fPreview" hover-class="hover"><text>{{$t('touxiang.yl')}}</text></view>
					<view @click="fUpload"  hover-class="hover"><text>{{$t('touxiang.sc')}}</text></view>
				</view>
			</view>
		</view>
	</view>
