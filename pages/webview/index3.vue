<template>
	<div class='divchart' style='background-color:#101010;' >
		...
		<div class="button-sp-area">
			<button class="mini-btn" type="default" size="mini" @click="ChangeMinutePeriod(MINUTE_PERIOD_ID.MINUTE_ID)">{{$t('webview.fs')}}</button>
			<button class="mini-btn" type="default" size="mini" @click="ChangeMinutePeriod(MINUTE_PERIOD_ID.MINUTE_5DAY_ID)">5{{$t('webview.ri')}}</button>
			<button class="mini-btn" type="default" size="mini" @click="ChangeKLinePeriod(KLINE_PERIOD_ID.KLINE_DAY_ID)">{{$t('webview.rx')}}</button>
			<button class="mini-btn" type="default" size="mini" @click="ChangeKLinePeriod(KLINE_PERIOD_ID.KLINE_WEEK_ID)">{{$t('webview.zx')}}</button>
			<button class="mini-btn" type="default" size="mini" @click="ChangeKLinePeriod(KLINE_PERIOD_ID.KLINE_MINUTE_ID)">1{{$t('webview.fz')}}</button>
			<button class="mini-btn" type="default" size="mini" @click="ChangeKLinePeriod(KLINE_PERIOD_ID.KLINE_15MINUTE_ID)">15{{$t('webview.fz')}}</button>
		</div>
		<div class="button-sp-area">
			<button class="mini-btn" type="default" size="mini" @click="ChangeKLineIndex(0,'EMPTY')">{{$t('webview.ztkzb')}}</button>
...
export default 
{
	...
	onShow() 
	{
		JSCommon.JSChart.SetDomain("https://opensource.zealink.com");
	},
