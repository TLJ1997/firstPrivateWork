<template>
	<view class="content">
		<view class="muen_header hi-columns" style="padding-top:30px;" :style="hb_status?'background:#05060F;':'background:#ffffff;'">
			<view class="hi-rows hi-flex-vcenter  hi-space-between">
				<view class="hi-rows hi-flex-vcenter">
					<image
						src="../../../static/home/nav_icon_back_night.png"
						mode=""
						style="width:46upx;height: 46upx;"
						@click="Back()"
					></image>
				</view>
				<view class="hi-rows hi-flex-vcenter" style="font-size: 35upx; font-weight: bold;color: white;">{{$t('afanda.wdzt')}}</view>
