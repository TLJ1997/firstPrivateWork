	...
	<view class="container hi-columns" :style="backgroundALL == '#1c1f22'?'background:#18253D;':'background:#F0F3F5;'">
		...
		<view class="header_title_box hi-columns hi-flex-vcenter">
			<view class="header_item hi-rows hi-flex-vcenter" style="align-self: flex-start;">
				<text class="t1" :style="hb_status?'color: #242833;font-size: 48upx;':'color: #ffffff;font-size: 48upx;'">{{$t('wo.jysjs')}}</text>
		...
		<view class="items hi-rows">
			<text class="ts" :style="hb_status?'color: #242933;':'color:#FFFFFF'">{{$t('wo.jys_text')}}</text>
		</view>
...
<style>
	...
	.items{margin: 0 40upx;}
	.items .ts{font-size: 32upx;line-height:50upx;text-indent: 40upx;}
